 ...
 *
 * @class TYPO3.Form.Wizard.Elements.Basic.Recaptcha
 * @extends TYPO3.Form.Wizard.Elements
 */
TYPO3.Form.Wizard.Elements.Basic.Recaptcha = Ext.extend(TYPO3.Form.Wizard.Elements, {
    /**
    ...
    constructor: function(config) {
        Ext.apply(this, {
            configuration: {
                attributes: {
                    ...
                    'name': '',
                    'type': 'button',
                    'value': TYPO3.l10n.localize('tx_form_domain_model_element_recaptcha.value')
                },
                filters: {},
                label: {
        ...
        TYPO3.Form.Wizard.Elements.Basic.Recaptcha.superclass.constructor.apply(this, arguments);
    }
});

Ext.reg('typo3-form-wizard-elements-basic-recaptcha', TYPO3.Form.Wizard.Elements.Basic.Recaptcha);
